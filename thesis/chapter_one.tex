...
\todoil{Is this true for all number of flavors? Check!}
...
\todoil{Some missing assumptions according to Matteo? Check!}
...
\end{align}
In the above, I neglect a constant and gave for implicit the harmonic approximation and integration of $\bm r=\bm r(r,\phi)$ with $r=\sqrt{(x-x')^2+u^2(\tau-\tau')^2}$ in polar coordinates.
