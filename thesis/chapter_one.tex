...
\begin{align}
    ...
    \\
    \rightarrow \braket{v_mv_n}\equiv A_{mn}^{-1}.
...
The $\cos$ term in (\cref{eq:rg_int_2}) yields a renormalization of the quadratic part after the harmonic approximation in polar coordinates $r=\sqrt{(x-x')^2+u^2(\tau-\tau')^2}$
\begin{align}
    -\frac12\braket{S^2_I[\phi_{\Lambda'}+h]}_{h,{\rm conn.}}
    \approx
...
\todo{Reference to the research and comment on other models aswell}
