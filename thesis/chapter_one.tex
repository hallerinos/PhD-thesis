...
In order to access correlation functions, the two sectors can be treated independently, therefore we focus first on properties of the non-interacting spinless Luttinger liquid at $K=1$.
