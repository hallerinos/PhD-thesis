...
(iii) In case of $y>|x|$, the coupling $y$ flows towards infinite, independently on the value of $x$.
...
\todoil{Maybe discuss divergent correlation length close to the critical line to argue why numerics has a hard time.}
