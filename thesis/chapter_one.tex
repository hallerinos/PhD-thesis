...
A one-body operator $\hat o$ diagonal in an arbitrary single-particle basis is trivially extended to the $N$-particle states written in the same basis
\begin{align}
    \hat O_1
...
Note the introduction of the so-called right and left operators $\hat c_{q,R/L}$ which annihilate particles propagating to the left/right with Fermi velocity $\pm v_F=\hbar k_F/m$.
...
We now proceed by explaining the basic renormalization group (RG) analysis of the sine-Gordon model, based on~\cite{Gogolin2004}.
