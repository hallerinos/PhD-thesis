...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\todo{Intro to be rewritten entirely}
...
\end{align}
To account for the fact that the indices $\bm i$ are not fixed to specific values, I will from now on denote the dependence of the tensor $C$ on the quantum numbers with square brackets, i.e $C^{[i_1,i_2,\dots,i_L]}$.
...
%
%
\todo{Mention it although not used up to now? Unsure...}
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
%
\todo{Very short explanation with reference to Silvi's bible}
