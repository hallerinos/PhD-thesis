...
At the end of the chapter, I explain how temperature and mixed states can be encoded in the framework of MPS, and I review shortly the exploit of Abelian symmetries in the numerical techniques which in general reduces the overall computational complexity.
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
In a second example, I consider a fraction of the Mandelbrot set embedded in Gaussian noise presented in \cref{fig:svd_image_compression_mandelbrot}.
