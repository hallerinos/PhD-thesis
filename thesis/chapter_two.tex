...
Its rank is defined as the number of indices: for instance, scalar values are of rank zero, vectors of rank one and matrices of rank two\footnote{
...
Essentially, the works can be summarized by the following statement~\cite{Eisert2010}:
...
The most straightforward example of a matrix product operator (MPO) is given through the Hamiltonian, and the derivation straightforward.
