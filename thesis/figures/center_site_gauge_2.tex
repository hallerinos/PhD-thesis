...
\begin{tikzpicture}
    ...
    \coordinate (tp) at ($(tp)+(0.5,0)$);
    \draw (tp) -- ++(0,-0.25) node[below] {$i_2$};
    \draw (tp) -- ++(0.25,0);
    \begin{scope}[rotate=-90,shift=(tp)]
        \tTens{gray}{0.25}{0.2}{(0,0)}
    \end{scope}
    ...
    \coordinate (tp) at ($(tp)+(0.5,0)$);
    \draw (tp) -- ++(0,-0.25) node[below] {$i_{\ell-1}$};
    \draw (tp) -- ++(-0.25,0);
    \draw (tp) -- ++(0.5,0);
    \begin{scope}[rotate=-90,shift=(tp)]
        \tTens{gray}{0.25}{0.2}{(0,0)}
    ...
    \coordinate (tp) at ($(tp)+(0.5,0)$);
    \draw (tp) -- ++(0,-0.25) node[below] {$i_\ell$};
    \draw (tp) -- ++(0.25,0);
    \begin{scope}[rotate=-90,shift=(tp)]
        \tTens{green}{0.25}{0.2}{(0,0)}
    \end{scope}

    \coordinate (tp) at ($(tp)+(0.25,0)$);
    % \draw (tp) -- ++(0,-0.25) node[below] {$i_\ell$};
    \draw (tp) -- ++(0.25,0);
    \begin{scope}[rotate=45,shift=(tp)]
        \rTens{green}{0.15}{0.15}{(0,0)}
    \end{scope}
    ...
    \coordinate (tp) at ($(tp)+(0.5,0)$);
    \draw (tp) -- ++(0,-0.25) node[below] {$i_{L-1}$};
    \draw (tp) -- ++(-0.25,0);
    \draw (tp) -- ++(0.5,0);
    \begin{scope}[rotate=90,shift=(tp)]
        \tTens{gray}{0.25}{0.2}{(0,0)}
