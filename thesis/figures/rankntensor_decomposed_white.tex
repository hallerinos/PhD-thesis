...
\begin{tikzpicture}
  \color{white}
    \node (rw1) at (0,0) {};
    \draw ($(rw1)+(-1.75,0)$) node[left] {$i_1$} --($(rw1)+(1.75,0)$) node[right] {$i_n$};
    \coordinate (1) at ($(rw1)+(-1.75,0)$);
    \foreach \y in {1}{
        \draw ($(1)+(0.5,0)$) coordinate (1) -- ++(0,-0.25);
    }
    \node[below,yshift=-.175cm] at (1) {$i_2$};
    \node[yshift=-.125cm] at ($(1)+(0.5,0)$) {$\dots$};
    \coordinate (1) at ($(1)+(0.5,0)$);
    \foreach \y in {1,2}{
        \draw ($(1)+(0.5,0)$) coordinate (1) -- ++(0,-0.25);
    }
    \node[below,yshift=-.175cm] at ($(1)+(-.5,0)$) {$i_j$};
    \node[below,yshift=-.175cm] at (1) {$i_{j+1}$};
    \node[yshift=-.125cm] at ($(1)+(0.5,0)$) {$\dots$};
    \coordinate (1) at ($(1)+(0.5,0)$);
    \foreach \y in {1}{
        \draw ($(1)+(0.5,0)$) coordinate (1) -- ++(0,-0.25);
    }
    \node[below,yshift=-.175cm] at (1) {$i_{n-1}$};
    % \rTens{gray}{3}{0.25}{(rw1)}
    \coordinate (tp1) at ($(rw1)+(+0.8,0)$);
    \coordinate (tp2) at ($(rw1)+(-0.8,0)$);
    \coordinate (tp3) at ($0.5*(tp1)+0.5*(tp2)$);
    \begin{scope}[rotate=90,shift=(tp1)]
        \tTens{gray}{0.25}{1.4}{(0,0)}
    \end{scope}
