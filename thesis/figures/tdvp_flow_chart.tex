...
\begin{tikzpicture}
    ...
    \node[punkt] (a2) at (0,4) {2. Local evolution};
    \node[punkt] (a) {2. Local evolution};
    ...
    \node[punkt] (g) at (-3,2) {3. Move $\bm A_C$ to the right, $n\rightarrow n+1$} edge[pil, bend right=45] node[below,pos=.4,xshift=-.8cm] {if $n=L$} (a.west);
