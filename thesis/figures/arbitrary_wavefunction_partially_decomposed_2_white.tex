...
\begin{tikzpicture}
  \color{white}
    ...
    \node[below,yshift=-.175cm,xshift=-0.75cm] at (1) {$i_2$};
    \node[below,yshift=-.175cm] at (1) {$i_3$};

    \node[yshift=-.125cm] at ($(1)+(0.75,-.1)$) {$\dots$};

    \coordinate (1) at ($(1)+(0.75,0)$);
    \foreach \y in {1,2,3}{
        \draw ($(1)+(0.75,0)$) coordinate (1) -- ++(0,-0.25);
    }
    \node[below,yshift=-.175cm] at ($(1)+(-1.5,0)$) {$i_{L-2}$};
    ...
    \rTens{gray}{3.25}{0.25}{($(cc)+(0.75,0)$)}

    % \coordinate (tp) at ($(cc)+(-0.75,0)$);
    % \begin{scope}[rotate=-90,shift=(tp)]
    %     \tTens{red}{0.25}{0.2}{(0,0)}
    % \end{scope}
    % \coordinate (tp) at ($(cc)+(-0.55,0)$);
    % \cTens{gray}{0.05}{(tp)}
    % \coordinate (tp) at ($(cc)+(-0.35,0)$);
    % \begin{scope}[rotate=90,shift=(tp)]
    %     \tTens{gray}{0.25}{0.2}{(0,0)}
    % \end{scope}
\end{tikzpicture}
