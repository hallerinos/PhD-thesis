...
It is then easy to identify the tensor contraction of two matrices as
\begin{align}
    C_{\alpha\beta}=\sum_{\gamma=1}^mA_{\alpha\gamma}B_{\gamma\beta}=\includegraphics[valign=c]{figures/MatrixMultiplication.pdf}
\end{align}
