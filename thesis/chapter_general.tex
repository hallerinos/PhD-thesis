...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Nearly free systems}
...
Such types can be found in traditional solid state scenarios where the nuclei are well separated beyond the typical Bohr radius of the valence electrons, in setups of ultracold atoms trapped in optical lattices (see \cref{sec:ultracold_atoms_trapped_in_optical_lattices}), in optical waveguides or polaritons.
...
\label{sec:ultracold_atoms_trapped_in_optical_lattices}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
