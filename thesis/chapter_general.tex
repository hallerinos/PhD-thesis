...
Some insights were concluded by the universal scaling laws of the entropy provided by Calabrese and Cardy in 2004~\cite{Calabrese2004} in proximity of a quantum critical point.
It was until 2007, that Hastings published his famous proof of the area law for one-dimensional quantum systems~\cite{Hastings2007}.
In its essence, it provides an upper bound to the von Neumann entropy for gapped and local (i.e. no long-ranged interactions) Hamiltonians scaling as the area ($\equiv$ a constant) of the one-dimensional system.
Essentially, the two works can be summarized by the following statement
