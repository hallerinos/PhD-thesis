...
To apply the general equations in a solid-state context, let me now exploit the previous equations for a generic $2\times 2$ Bloch Hamiltonian spanned by the vector of Pauli matrices $\bm\sigma$ as
\begin{align}
