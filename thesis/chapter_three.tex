...
Two systems I, II are called topologically equivalent, if their corresponding Bloch Hamiltonians $H_{\rm I}$, $H_{\rm II}$ can be adiabatically connected without closing the energy gap.
...
All the other equivalence classes are by definition not adiabatically connected to the atomic insulator and thus called topological insulators (TOI) or topological superconductors.
Since the latter will not play a role for this thesis, I spare the introduction of an abbreviation do not dive into the topic of superconductivity here.
