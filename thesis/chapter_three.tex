...
\begin{align}
    ...
    \end{array}
\end{align}
In particular, this set of symmetries is exhaustive and spans the ten possible behaviors of the Hamiltonian~\cite{Chiu2016}:
(i) $H$ is not time reversal invariant, denoted by $T=0$, (ii) $H$ is time reversal invariant and $T$ squares to $+\mathbb1$ in which case we write $T=+1$ and (iii) $H$ is time reversal invariant and $T$ squares to $-1$, denoted by $T=-1$.
