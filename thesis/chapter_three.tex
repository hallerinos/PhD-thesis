...
In contrast, the two different phases cannot be connected by a path which preserves the band gap, as any parameter path necessarily needs to cross $J=J'$, which is the critical point with $\Delta=0$.
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
